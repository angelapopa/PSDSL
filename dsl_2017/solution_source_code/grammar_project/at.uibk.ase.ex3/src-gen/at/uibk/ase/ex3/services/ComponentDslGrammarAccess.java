...
public class ComponentDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cParentEntityBaseTypeEnumEnumRuleCall_3_0 = (RuleCall)cParentAssignment_3.eContents().get(0);
		...
		//// | 'Member' {Member};
		//Entity:
		//	'entity' name=ID 'extends' parent=EntityBaseTypeEnum '{'
		//	attributes+=Attribute*
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'entity' name=ID 'extends' parent=EntityBaseTypeEnum '{' attributes+=Attribute* '}'
		public Group getGroup() { return cGroup; }
		...
		//parent=EntityBaseTypeEnum
		public Assignment getParentAssignment_3() { return cParentAssignment_3; }
		
		//EntityBaseTypeEnum
		public RuleCall getParentEntityBaseTypeEnumEnumRuleCall_3_0() { return cParentEntityBaseTypeEnumEnumRuleCall_3_0; }
	...
	public class EntityBaseTypeEnumElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "at.uibk.ase.ex3.ComponentDsl.EntityBaseTypeEnum");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final EnumLiteralDeclaration cMEMBEREnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cMEMBERMemberKeyword_1_0 = (Keyword)cMEMBEREnumLiteralDeclaration_1.eContents().get(0);
		
		//enum EntityBaseTypeEnum:
		...
		//MEMBER='Member'
		public EnumLiteralDeclaration getMEMBEREnumLiteralDeclaration_1() { return cMEMBEREnumLiteralDeclaration_1; }
		
		//'Member'
		public Keyword getMEMBERMemberKeyword_1_0() { return cMEMBERMemberKeyword_1_0; }
	}
	
	private final ModelElements pModel;
	private final TerminalRule tVERSION;
	private final EntityBaseTypeEnumElements eEntityBaseTypeEnum;
	...
	public ComponentDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.eEntityBaseTypeEnum = new EntityBaseTypeEnumElements();
	...
	//enum EntityBaseTypeEnum:
	//	GROUP='Group' | MEMBER='Member';
	public EntityBaseTypeEnumElements getEntityBaseTypeEnumAccess() {
		return eEntityBaseTypeEnum;
	}
	
	public EnumRule getEntityBaseTypeEnumRule() {
		return getEntityBaseTypeEnumAccess().getRule();
	}
