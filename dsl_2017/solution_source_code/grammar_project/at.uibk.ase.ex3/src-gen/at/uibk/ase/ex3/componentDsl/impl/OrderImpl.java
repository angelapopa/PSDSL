 ...
 * </p>
 * <ul>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.impl.OrderImpl#getSource <em>Source</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.impl.OrderImpl#getSourceName <em>Source Name</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.impl.OrderImpl#getSourceVersion <em>Source Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderImpl extends ActionImpl implements Order
{
  /**
  ...
  {
    return ComponentDslPackage.Literals.ORDER;
  }
  ...
  public NotificationChain basicSetSource(EntityType newSource, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentDslPackage.ORDER__SOURCE, oldSource, newSource);
  ...
  public void setSource(EntityType newSource)
  {
    if (newSource != source)
    {
      ...
      if (source != null)
        msgs = ((InternalEObject)source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentDslPackage.ORDER__SOURCE, null, msgs);
      if (newSource != null)
        msgs = ((InternalEObject)newSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentDslPackage.ORDER__SOURCE, null, msgs);
      msgs = basicSetSource(newSource, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComponentDslPackage.ORDER__SOURCE, newSource, newSource));
  }
  ...
  public void setSourceName(String newSourceName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComponentDslPackage.ORDER__SOURCE_NAME, oldSourceName, sourceName));
  }
  ...
  public void setSourceVersion(String newSourceVersion)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComponentDslPackage.ORDER__SOURCE_VERSION, oldSourceVersion, sourceVersion));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ComponentDslPackage.ORDER__SOURCE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComponentDslPackage.ORDER__SOURCE:
        return getSource();
      case ComponentDslPackage.ORDER__SOURCE_NAME:
        return getSourceName();
      case ComponentDslPackage.ORDER__SOURCE_VERSION:
