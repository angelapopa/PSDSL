 ...
 * </p>
 * <ul>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.Cycle#getSource <em>Source</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.Cycle#getSourceName <em>Source Name</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.Cycle#getSourceVersion <em>Source Version</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.Cycle#getDest <em>Dest</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.Cycle#getDestinationName <em>Destination Name</em>}</li>
 *   <li>{@link at.uibk.ase.ex3.componentDsl.Cycle#getDestinationVersion <em>Destination Version</em>}</li>
 * </ul>
 *
 * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle()
 * @model
 * @generated
 */
public interface Cycle extends Action
{
  /**
   ...
   * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle_Source()
  ...
  /**
   * Sets the value of the '{@link at.uibk.ase.ex3.componentDsl.Cycle#getSource <em>Source</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle_SourceName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.uibk.ase.ex3.componentDsl.Cycle#getSourceName <em>Source Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle_SourceVersion()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.uibk.ase.ex3.componentDsl.Cycle#getSourceVersion <em>Source Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle_Dest()
   * @model containment="true"
   * @generated
   */
  EntityType getDest();
  ...
  /**
   * Sets the value of the '{@link at.uibk.ase.ex3.componentDsl.Cycle#getDest <em>Dest</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle_DestinationName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.uibk.ase.ex3.componentDsl.Cycle#getDestinationName <em>Destination Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.uibk.ase.ex3.componentDsl.ComponentDslPackage#getCycle_DestinationVersion()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.uibk.ase.ex3.componentDsl.Cycle#getDestinationVersion <em>Destination Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
