 ...
 */
package org.xtext.asea3.mydsl.services;
...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DomainmodelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.asea3.mydsl.MyDsl.Domainmodel");
	...
	public class TypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.asea3.mydsl.MyDsl.Type");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cDataTypeParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cEntityParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cCreateProjectParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		
		//Type:
		//	DataType | Entity | CreateProject;
		@Override public ParserRule getRule() { return rule; }
		...
		//CreateProject
		public RuleCall getCreateProjectParserRuleCall_2() { return cCreateProjectParserRuleCall_2; }
	}
	public class DataTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.asea3.mydsl.MyDsl.DataType");
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.asea3.mydsl.MyDsl.Entity");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CreateProjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.asea3.mydsl.MyDsl.CreateProject");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCreate_projectKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		private final Keyword cIn_versionKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cNameAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cNameIDTerminalRuleCall_3_0 = (RuleCall)cNameAssignment_3.eContents().get(0);
		
		//CreateProject:
		//	'create_project' name=ID 'in_version' name=ID;
		@Override public ParserRule getRule() { return rule; }
		...
		//'create_project'
		public Keyword getCreate_projectKeyword_0() { return cCreate_projectKeyword_0; }
		...
		//'in_version'
		public Keyword getIn_versionKeyword_2() { return cIn_versionKeyword_2; }
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.asea3.mydsl.MyDsl.Feature");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final CreateProjectElements pCreateProject;
	...
	public MyDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pCreateProject = new CreateProjectElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.asea3.mydsl.MyDsl".equals(grammar.getName())) {
				return grammar;
			}
