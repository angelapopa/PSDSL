...
public class ComponentDslValidator extends AbstractComponentDslValidator {
  ...
  public void checkDependencyAssignmentSource(final AddDependency addDependency) {
    EntityBaseType _parent = addDependency.getSource().getEntity().getParent();
    if ((_parent instanceof Group)) {
  ...
  public void checkDependencyAssignmentDestination(final AddDependency addDependency) {
    EntityBaseType _parent = addDependency.getDest().getEntity().getParent();
    if ((_parent instanceof Group)) {
  ...
  public void checkAssignmentSourceType(final Add addAction) {
    EntityBaseType _parent = addAction.getSource().getEntity().getParent();
    if ((_parent instanceof Group)) {
  ...
  public void checkAssignmentDestType(final Add addAction) {
    EntityBaseType _parent = addAction.getDest().getEntity().getParent();
    if ((_parent instanceof Member)) {
  ...
  public ArrayList<EntityType> getAllProjects(final List<Object> candidates) {
    ...
    for (final Object c : candidates) {
      if ((c instanceof EntityType)) {
        ...
        if (((proj.getEntity().getParent() instanceof Member) && (proj.getName() != null))) {
  ...
  public ArrayList<EntityType> getAllComponents(final List<Object> candidates) {
    ...
    for (final Object c : candidates) {
      if ((c instanceof EntityType)) {
        final EntityType proj = ((EntityType) c);
        if (((proj.getEntity().getParent() instanceof Group) && (proj.getName() != null))) {
  ...
  public void checkUsage(final Size sizeAction) {
    EntityBaseType _parent = sizeAction.getSource().getEntity().getParent();
    if ((_parent instanceof Member)) {
  ...
  public void checkUsage(final Order orderAction) {
    EntityBaseType _parent = orderAction.getSource().getEntity().getParent();
    if ((_parent instanceof Member)) {
  ...
  public void checkUsage(final Cycle cycleAction) {
    EntityBaseType _parent = cycleAction.getSource().getEntity().getParent();
    if ((_parent instanceof Member)) {
    ...
    EntityBaseType _parent_1 = cycleAction.getDest().getEntity().getParent();
    if ((_parent_1 instanceof Member)) {
