...
public class EntitiesGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.entities.Entities.Model");
		...
		///*AST */ /*a collection of entities, a list (+=) */ /*star means 0 or n elements */
		///*plus would have meant at least on element */ Model:
		//	entities+=Entity*;
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.entities.Entities.Entity");
		...
		private final RuleCall cAttributesAttributeTypeParserRuleCall_4_0 = (RuleCall)cAttributesAssignment_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		///*shape of Entity elements */ /* keywords of our grammar should be expressed with '' */
		///* ID rule inherited from Terminals */ /* () mark optional arguments  */
		///* [] marks a restriction that only existing Entity names should be used */ Entity:
		//	'entity' name=ID ('extends' superType=[Entity])? '{'
		//	attributes+=AttributeType*
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'entity' name=ID ('extends' superType=[Entity])? '{' attributes+=AttributeType* '}'
		...
		//AttributeType
		public RuleCall getAttributesAttributeTypeParserRuleCall_4_0() { return cAttributesAttributeTypeParserRuleCall_4_0; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_5() { return cRightCurlyBracketKeyword_5; }
	}
	public class AttributeTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.entities.Entities.AttributeType");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		///* shape of attribute elements */ AttributeType:
	...
	public class ElementTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.entities.Entities.ElementType");
		...
		//// Rule based on two mutually exclusive rules
		//ElementType:
