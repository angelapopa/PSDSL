 ...
 */
package org.xtext.asea3.mydsl.ide.contentassist.antlr;
...
import org.xtext.asea3.mydsl.ide.contentassist.antlr.internal.InternalMyDslParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCreateProjectAccess().getNameAssignment_1(), "rule__CreateProject__NameAssignment_1");
					put(grammarAccess.getCreateProjectAccess().getNameAssignment_3(), "rule__CreateProject__NameAssignment_3");
