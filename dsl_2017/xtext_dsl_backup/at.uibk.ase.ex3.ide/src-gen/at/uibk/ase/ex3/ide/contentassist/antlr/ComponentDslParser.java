	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getEntityBaseTypeAccess().getAlternatives(), "rule__EntityBaseType__Alternatives");
					...
					put(grammarAccess.getEntityBaseTypeAccess().getGroup_0(), "rule__EntityBaseType__Group_0__0");
					put(grammarAccess.getEntityBaseTypeAccess().getGroup_1(), "rule__EntityBaseType__Group_1__0");
