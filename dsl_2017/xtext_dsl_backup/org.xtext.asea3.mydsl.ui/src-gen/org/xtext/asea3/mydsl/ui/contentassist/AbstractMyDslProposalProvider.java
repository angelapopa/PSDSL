 ...
 */
package org.xtext.asea3.mydsl.ui.contentassist;
...
public abstract class AbstractMyDslProposalProvider extends TerminalsProposalProvider {
	...
	public void completeCreateProject_Name(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		completeRuleCall(((RuleCall)assignment.getTerminal()), context, acceptor);
	}
