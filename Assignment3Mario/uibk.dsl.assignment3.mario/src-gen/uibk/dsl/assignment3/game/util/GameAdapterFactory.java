...
public class GameAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected GameSwitch<Adapter> modelSwitch =
    new GameSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseCharacter(uibk.dsl.assignment3.game.Character object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link uibk.dsl.assignment3.game.Character <em>Character</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
