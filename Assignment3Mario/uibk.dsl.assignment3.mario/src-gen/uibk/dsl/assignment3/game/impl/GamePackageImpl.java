...
public class GamePackageImpl extends EPackageImpl implements GamePackage
{
   ...
   * @generated
   */
  public EAttribute getCharacter_HealthPoints()
  {
   ...
   * @generated
   */
  public EAttribute getObject_HealthPoints()
  {
   ...
   * @generated
   */
  public EAttribute getObject_Actions()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(characterEClass, CHARACTER__HEALTH_POINTS);
    createEReference(characterEClass, CHARACTER__ACTIONS);

    objectEClass = createEClass(OBJECT);
    createEReference(objectEClass, OBJECT__SUPER_TYPE);
    createEAttribute(objectEClass, OBJECT__HEALTH_POINTS);
    createEAttribute(objectEClass, OBJECT__ACTIONS);
  ...
  public void initializePackageContents()
  {
    ...
    characterEClass.getESuperTypes().add(this.getIngredient());
    ...
    initEClass(characterEClass, uibk.dsl.assignment3.game.Character.class, "Character", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCharacter_HealthPoints(), ecorePackage.getEInt(), "healthPoints", null, 0, 1, uibk.dsl.assignment3.game.Character.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCharacter_Actions(), this.getStep(), null, "actions", null, 0, -1, uibk.dsl.assignment3.game.Character.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getObject_HealthPoints(), ecorePackage.getEInt(), "healthPoints", null, 0, 1, uibk.dsl.assignment3.game.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getObject_Actions(), this.getAction(), "actions", null, 0, -1, uibk.dsl.assignment3.game.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
