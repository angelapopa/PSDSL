...
import uibk.dsl.assignment3.generator.GameGenerator;
import uibk.dsl.assignment3.parser.antlr.GameAntlrTokenFileProvider;
import uibk.dsl.assignment3.parser.antlr.GameParser;
import uibk.dsl.assignment3.parser.antlr.internal.InternalGameLexer;
import uibk.dsl.assignment3.scoping.GameScopeProvider;
import uibk.dsl.assignment3.serializer.GameSemanticSequencer;
import uibk.dsl.assignment3.serializer.GameSyntacticSequencer;
import uibk.dsl.assignment3.services.GameGrammarAccess;
import uibk.dsl.assignment3.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "uibk/dsl/assignment3/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("uibk.dsl.assignment3.Game");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("Mario");
	}
