 ...
 * </p>
 * <ul>
 *   <li>{@link uibk.dsl.assignment1.jsonldConverter.impl.ModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return JsonldConverterPackage.Literals.MODEL;
  }
  ...
  public EList<Type> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Type>(Type.class, this, JsonldConverterPackage.MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JsonldConverterPackage.MODEL__ELEMENTS:
