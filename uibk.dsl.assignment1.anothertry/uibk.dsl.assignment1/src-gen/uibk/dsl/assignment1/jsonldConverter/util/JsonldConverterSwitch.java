 ...
 * @generated
 */
public class JsonldConverterSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case JsonldConverterPackage.TYPE:
      {
      ...
      {
        uibk.dsl.assignment1.jsonldConverter.Enum enum_ = (uibk.dsl.assignment1.jsonldConverter.Enum)theEObject;
   ...
   * @generated
   */
  public T caseEnum(uibk.dsl.assignment1.jsonldConverter.Enum object)
  {
    return null;
  }
