...
public class TestOsciGroovyT extends JApplet {
	/**
	 * 
	 */
...
TestOsciGroovyT applet = new TestOsciGroovyT();
JAppletFrame frameG = new JAppletFrame("SawFaders", applet);
frameG.setSize(440, 200);//Frame
